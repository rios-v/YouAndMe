          ...
          >
            ...
            >
              ...
              <p className="text-sm text-[var(--text-secondary)] mb-6">
                Essa ação não pode ser desfeita. A carta será apagada para sempre.
              </p>
              <div className="flex gap-3">
                <button
                  onClick={onCancel}
                  disabled={isDeleting}
                  className="flex-1 py-3 rounded-2xl font-semibold text-[var(--text-primary)] bg-[var(--bg-main)]"
                >
                  Cancelar
                </button>
                <button
                  onClick={onConfirm}
                  disabled={isDeleting}
                  className="flex-1 py-3 rounded-2xl font-semibold text-white bg-red-500 flex items-center justify-center gap-2 disabled:opacity-70"
                >
